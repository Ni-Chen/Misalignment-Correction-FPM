...
%% Coarse correction of the misallignment and rotation
%    opts.poscalibrate = 0;
opts.calbratetol = 1e-3;
poscost = @(zz) pie_solver_coarse(zz, imSeqLowRes, m, n, arraysize, m1, n1, dkx, dky, CTF, H, loop);
...
%% Fine correction
loop = 2;
[obj_pie, pupil_pie] = pie_solver_fine(ledfit, imSeqLowRes, m, n, arraysize, m1, n1, dkx, dky, CTF, H, loop);
