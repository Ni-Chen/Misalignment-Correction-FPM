...
loop = 9;
% [obj_pie,pupil_pie] = pie_solver(imSeqLowRes,m,n,arraysize,m1,n1,dkx,dky,kx,ky,CTF,H,loop);
[obj_pie, pupil_pie] = pie_solver_led(imSeqLowRes, m, n, arraysize, m1, n1, dkx, dky, kx, ky, CTF, H, loop);
...
% save('E:\�ҵĿ���\matlab\fpm\simulation1\fpmsimu.mat','imSeqLowRes');
